...
export const sovereignSurfaces: SovereignSurface[] = [
  ...
  },
  {
    ...
    owner: 'Kopano Labs',
    kind: 'service',
    description: 'Bounded POC for official South African government-service discovery and governed action receipts.',
    mode: 'gateway',
    trust: 'governed',
    status: 'prototype',
    accent: '#ffe66d',
...
export const integrationCandidates: SovereignSurface[] = [
  {
    ...
    owner: 'External',
    kind: 'integration',
    description: 'Bounded public media discovery through the validated rigid gateway and KC receipt hand-off.',
    mode: 'gateway',
    trust: 'external',
    status: 'live',
    accent: '#ff4b4b',
